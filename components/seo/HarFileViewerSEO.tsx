    ...
    <div className="content-wrapper">
      <section>
        <p>
          ...
          Debugging network performance has never been easier (or
          has it?).
        </p>
      ...
      <section>
        ...
        <p>
          ...
          traffic. With the HAR file viewer you can see network performance and troubleshoot the root cause of front-end bugs.
        </p>
        <ul>
          <li>
        ...
        <p>
          You can make your life a lot easier by asking your team to report bugs with Jam’s browser extension. 
          Jam auto-includes everything in a HAR file plus reproduction steps, custom metadata, and an AI 
          debugging assistant — all packaged and ready to go in a link.
        </p>
        <p>
