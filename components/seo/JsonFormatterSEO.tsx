...
export default function JsonFormatterSEO() {
  return (
    <div className="content-wrapper">
      <section>
        <p>
          You can use this JSON formatter to beautify your JSON and make it easier to read. Just paste
          your minified JSON and get the formatted result. Made with 💜 by the developers building Jam.
        </p>
      </section>
      ...
      <section>
        ...
        <p>Our tool's built-in JSON Validator ensures the
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <b>Data Interchange:</b> <br /> Well-structured JSON is easier to share
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <b>How to format JSON using a code editor?</b> <br /> You can use a code
