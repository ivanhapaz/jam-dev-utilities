    ...
    <div className="content-wrapper">
      <section>
        <p>
          ...
          free online tool. Made with 💜 by the developers building Jam.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          you can use this Query Params to JSON converter to 
          transform query strings into structured JSON objects.
          Just enter your URL query parameters and get the JSON output.
        </p>
      ...
      <section>
        ...
        <p>
          Debugging is annoying enough without manually extracting and converting URL query data.
          You can use Jam to capture all the essential information, including console logs,
